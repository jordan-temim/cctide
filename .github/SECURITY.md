...
- makes **one outbound network request**: the auto-updater checks `releases/latest/download/latest.json` on GitHub and, if the user clicks Install, downloads the signed bundle from the same release. No usage data or telemetry is ever sent.
